...
public class Piece {
	...
	public boolean Ligal (int fromY, int fromX,int toY, int toX) {
	...
	public boolean rightP (int y, int x) {
		String pl = Integer.toString(player);
		boolean bool1= ((piece [y] [x]).equals(pl));
		return bool1;
		}
